document.addEventListener('DOMContentLoaded', () => {
    ...
    (function(index){
        //add onclick to each square in your grid
    ...
    function checkBoard(){
        ...
        //now take the for values of each winning array and put them into squares
        for(let y = 0; y < winningArrays.length ; y++){
            ...
            if(
                ...
                //now check those arrays to se if they all have the class of player-two
                else if(
